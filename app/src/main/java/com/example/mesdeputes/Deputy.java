...
public class Deputy implements Serializable {
    ...
    private ArrayList<Responsability> responsabilites;
    ...
    public ArrayList<Responsability> getResponsabilites() {
        return responsabilites;
    }

    public void setResponsabilites(ArrayList responsabilites) {
